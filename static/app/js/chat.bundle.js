                  ...
                  ($("body").append(t),
                    ...
                    setTimeout(function () {
                      (0, r.default)(t, {
                        ...
                        ($("#lightBoxToggle").data("zui.lightbox").show(gifUrl),
                          $(t).remove(),
      ...
      var Pe = {
        ...
        a = {
          get SUPPORT_RANGE_BOUNDS() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_RANGE_BOUNDS", {
                value: A,
              }),
              A
            );
          ...
          get SUPPORT_SVG_DRAWING() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_SVG_DRAWING", {
                value: A,
              }),
              A
            );
          ...
          get SUPPORT_CORS_IMAGES() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_CORS_IMAGES", {
                value: A,
              }),
              A
            );
          ...
          get SUPPORT_RESPONSE_TYPE() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_RESPONSE_TYPE", {
                value: A,
              }),
              A
            );
          ...
          get SUPPORT_CORS_XHR() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_CORS_XHR", {
                value: A,
              }),
              A
            );
                        ...
                        : "counter" === A.name
                          ...
                          : "counters" === A.name &&
                            ...
                            n &&
                              ...
                              (n =
                                t && t.type === l.STRING_TOKEN ? t.value : ""),
                              (B = e
                                .map(function (A) {
                                  return gB(A, r, !1);
                                })
    ...
    A.exports = {
      ...
      data: {
        setting: {
          ...
          dialog_trans_remark: "",
          voice: 0,
          background: "http://49.234.30.79:18080/images/background-ddd.jpg",
          date_year: "",
          date_month: "",
          date_day: "",
          date_xinqi: "",
        ...
        users: [
          {
            id: "user-1",
            name: "阿熊熊₍ᐢ..ᐢ₎ 🎫",
            image: "http://49.234.30.79:18080/images/user-ddd.jpg",
            is_me: !0,
            selected: !0,
          },
          {
            id: "user-2",
            name: "甜甜",
            image: "http://49.234.30.79:18080/images/user2.png",
          },
        ],
        dialogs: [],
      },
      methods: {
        ...
        addDialog: function (A) {
          console.log(A);
          if (A.type === "text") {
            var contentWithBr = A.content.replace(/\n/g, "<br>");
            A.content = contentWithBr;
          }
          (this.dialogs.push(A),
            setTimeout(function () {
        ...
        addTextDialog: function () {
          ...
          if (!this.setting.dialog_content)
            return (alert("请输入对话内容"), !1);
          A = {
            id: "dialog-" + new Date().valueOf(),
            type: "text",
        ...
        transferGet: function (A) {
          var e = this.dialogs[A],
            ...
            A =
              (this.$set(this.dialogs[A], "is_get", !0),
              this.$set(this.dialogs[A], "remark", "已被接收"),
              e.trans_remark &&
                this.$set(
                  this.dialogs[A],
                  "remark",
